...
class SPSolver3D:
    ...
    def __init__(self, N, L):
        ...
        print(f"Simulation resolution: {L}^3")        
    ...
    def set_initial_density(self, rho_f):
        ...
        self.rho0, rhoc = rho_f(self.xx, self.yy, self.zz, self.L)
        self.vmax_auto  = rhoc
...
def rho0_soliton_3D(x, y, z, L):
    ...
    print(f"Central density order of magnitude: 10^{np.log10(rho0):.1f}")
